...
function SelectContent({
  ...
  const shouldAlignWithTrigger = alignItemWithTrigger ?? (position === "item-aligned");
  ...
  return (
    <SelectPrimitive.Portal>
      <SelectPrimitive.Positioner
        ...
        alignItemWithTrigger={shouldAlignWithTrigger}
        className="isolate z-50"
      >
        <SelectPrimitive.Popup
          data-slot="select-content"
          data-position={position}
          data-align-trigger={shouldAlignWithTrigger}
          className={cn(
